...
```bash
# 克隆代码
git clone http://192.168.1.205/bigdata/sxwt-hue4.git
...
# 修改汉化文件
#/usr/share/hue/desktop/core/src/desktop/locale/zh_CN/LC_MESSAGES/django.po
# 修改汉化文件后执行
# 执行语言编译 使汉化文件生效
./build/env/bin/hue compilemessages -l zh_CN
...
[[interpreters]]
  [[[mysql]]]
    ...
    options='{"url": "mysql://root:asdqwe123@docker:3306/hue"}'
# <<<
